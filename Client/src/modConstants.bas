...
Public Declare Function CallWindowProc Lib "user32" Alias "CallWindowProcA" (ByVal lpPrevWndFunc As Long, ByVal data As clsBuffer, ByVal msg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
