...
Route::group(['prefix' => 'api'], function() {
  ...
  Route::group(['prefix' => 'storage'], function() {
    Route::group(['prefix' => 'characters'], function() {
      ...
      Route::put   ('/create', ['as' => 'api.storage.characters.create', 'uses' => 'api\storage\CharacterController@create']);
      Route::delete('/delete', ['as' => 'api.storage.characters.delete', 'uses' => 'api\storage\CharacterController@delete']);
    });
  });
});